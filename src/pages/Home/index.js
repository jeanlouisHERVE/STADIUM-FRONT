  ...
  <div className="home">
      ...
      <div className= "part-association"> 
          ...
          <div className="part-association-img">
              <span class="material-icons material-icons material-icons--user">
              chevron_left
              </span>
                <img src={dashboardUser} className="dashboard-association-img" />
              <span class="material-icons material-icons--user--right">
                chevron_right
              </span>
          ...
          <div className="part-user-content">
            ...
            <div className="part-user-img">
              ...
              chevron_left
                ...
                <img src={dashboardUser} className="dashboard-user-img" /> 
              <span class="material-icons">
              chevron_right
              </span>
