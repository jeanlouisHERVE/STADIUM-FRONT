        ...
        <div className="dashboard-adherent-rightside">
          ...
          <div className="dashboard-adherent-presentation">
            <div className="dashboard-adherent-presentation-leftside">
              ...
              <p className="dashboard-adherent-document-label-upload">Télécharger le document <span class="material-icons-round">file_download</span>
              ...
              <div className="dashboard-adherent-documents-container">
                {adherentData.file && <p className="dashboard-adherent-document"><p className="strong">Certificat médical :</p> &nbsp;{adherentData.file.medicalCertificate ? <span className="material-icons" style={{ color: 'green' }}> task</span> : <span className="material-icons" style={{ color: 'red' }}>cancel</span> }</p>}
                {adherentData.file && <p className="dashboard-adherent-document"><p className="strong">Règlement intérieur : </p> &nbsp;{adherentData.file.rulesOfProcedure ? <span className="material-icons" style={{ color: 'green' }}> task</span> : <span className="material-icons" style={{ color: 'red' }}>cancel</span> }</p>}
              </div>
            </div>
